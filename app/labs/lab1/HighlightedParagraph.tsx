...
export default function HighlightedParagraphLab() {
  return (
    <div id="wd-highlighted-paragraph">
      ...
      />
      <HighlightedParagraph
      text="This is a personal paragraph with a light green background and dark green border. The border is 2 pixels wide and has a border radius of 12 pixels. I am writing this on a Wednesday evening."
